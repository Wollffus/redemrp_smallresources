...
local bathData = {
    { -- St Denis
        coords = vector3(2632.23, -1224.02, 59.59), -- Start bath prompt
        coordsgoto =  vector3(2630.17, -1223.78, 59.59), -- Walk to this point before tp to bath
        coordstarget =  vector3( 2630.17, -1223.78, 59.59),
        cameracoords1 = vector3( 2631.44, -1223.08, 59.59),
        cameracoords2 = vector3( 2629.41, -1223.82, 59.61),
        quitcoords = vector3( 2633.16, -1226.42, 59.59), -- This is where you end up when you are done bathing
        tp = vector3(2629.41, -1224.20, 59.61), -- This is where you character ends up
        -- X moves towards you or away, y moves left to right, z moves up or down (this is from your screen view)
        heading = 5.57 -- Which way they are facing in the bath
    },
